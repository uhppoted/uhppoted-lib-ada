...
package body Uhppoted.Lib.Integration_Tests.Default is
   ...
   procedure Test_Delete_Card (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Delete_Card (U, 405419896, 10058400, 0.5);
   begin
   ...
   procedure Test_Get_Event_Index (T : in out Test_Case'Class) is
      ...
      V : constant Unsigned_32 := Get_Event_Index (U, 405419896, 0.5);
   begin
   ...
   procedure Test_Set_Event_Index (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Set_Event_Index (U, 405419896, 13579, 0.5);
   begin
   ...
   procedure Test_Clear_Time_Profiles (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Clear_Time_Profiles (U, 405419896, 0.5);
   begin
   ...
   procedure Test_Clear_Task_List (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Clear_Task_List (U, 405419896, 0.5);
   begin
   ...
   procedure Test_Set_Interlock (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Set_Interlock (U, 405419896, To_Interlock (8), 0.5);
   begin
   ...
   procedure Test_Set_Antipassback (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Set_Antipassback (U, 405419896, To_Antipassback (2), 0.5);
   begin
   ...
   procedure Test_Restore_Default_Parameters (T : in out Test_Case'Class) is
      ...
      V : constant Boolean := Restore_Default_Parameters (U, 405419896, 0.5);
   begin
