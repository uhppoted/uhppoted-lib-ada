...
package Uhppoted.Lib.Integration_Tests.Stub.Replies is
   ...
   Delete_All_Cards_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Event_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Event_Not_Found_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Event_Overwritten_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Event_Index_Reply : constant Reply_List := [
      1 => [
   ...
   Set_Event_Index_Reply : constant Reply_List := [
      1 => [
   ...
   Record_Special_Events_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Time_Profile_Reply : constant Reply_List := [
      1 => [
   ...
   Set_Time_Profile_Reply : constant Reply_List := [
      1 => [
   ...
   Clear_Time_Profiles_Reply : constant Reply_List := [
      1 => [
   ...
   Add_Task_Reply : constant Reply_List := [
      1 => [
   ...
   Refresh_Task_List_Reply : constant Reply_List := [
      1 => [
   ...
   Clear_Task_List_Reply : constant Reply_List := [
      1 => [
   ...
   Set_Pc_Control_Reply : constant Reply_List := [
      1 => [
   ...
   Set_Interlock_Reply : constant Reply_List := [
      1 => [
   ...
   Activate_Keypads_Reply : constant Reply_List := [
      1 => [
   ...
   Get_Antipassback_Reply : constant Reply_List := [
      1 => [
   ...
   Set_Antipassback_Reply : constant Reply_List := [
      1 => [
   ...
   Set_First_Card_Reply : constant Reply_List := [
      1 => [
   ...
   Restore_Default_Parameters_Reply : constant Reply_List := [
      1 => [
