...
private
   ...
   function BCD_To_String (Bytes : Uhppoted.Lib.Types.BCD)
      return String;

   --  Translates a BCD coded version to a vN.NN formatted string.
   function Unpack_Version (V : Uhppoted.Lib.Replies.Version_Field)
      return Ada.Strings.Unbounded.Unbounded_String;

   --  Translates an Unsigned_8 into a Boolean.
   function Unpack_Boolean (B : Unsigned_8)
      return Boolean;

   --  Translates a BCD coded date to a DateOnly.
   function Unpack_Date (Bytes : Uhppoted.Lib.Types.BCD)
      return DateOnly;

   --  Translates a BCD coded YYMMDD date to a DateOnly.
   function Unpack_Short_Date (Bytes : Uhppoted.Lib.Types.BCD)
      return DateOnly;

   --  Translates a BCD coded time to a TimeOnly.
   function Unpack_Time (Bytes : Uhppoted.Lib.Types.BCD)
      return TimeOnly;

   --  Translates a BCD coded date/time to a DateTime.
   function Unpack_Date_Time (Bytes : Uhppoted.Lib.Types.BCD)
      return DateTime;
