...
package Uhppoted.Lib.Decode.Invalid_SOM_Tests is
   ...
   procedure Test_Get_Time_Profile_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_Time_Profile_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Clear_Time_Profiles_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Add_Task_Invalid_SOM       (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Refresh_Tasklist_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Clear_Tasklist_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_PC_Control_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_Interlock_Invalid_SOM  (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Activate_Keypads_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Antipassback_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_Antipassback_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_Firstcard_Invalid_SOM  (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Restore_Default_Parameters_Invalid_SOM (T : in out AUnit.Test_Cases.Test_Case'Class);
