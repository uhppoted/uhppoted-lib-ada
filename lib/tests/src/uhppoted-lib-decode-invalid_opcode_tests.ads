...
package Uhppoted.Lib.Decode.Invalid_OpCode_Tests is
   ...
   procedure Test_Get_Card_Invalid_OpCode       (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Card_Not_Found_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Card_At_Index_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Put_Card_Invalid_OpCode       (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Get_Event_Invalid_OpCode      (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Event_Not_Found_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Event_Overwritten_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Record_Special_Events_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Get_Time_Profile_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Clear_Tasklist_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   procedure Test_Set_PC_Control_Invalid_OpCode (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Set_Firstcard_Invalid_OpCode  (T : in out AUnit.Test_Cases.Test_Case'Class);
