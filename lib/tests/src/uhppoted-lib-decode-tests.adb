...
package body Uhppoted.Lib.Decode.Tests is
   ...
   procedure Test_Decode_Set_Time_Profile (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Response : constant Set_Time_Profile_Response := Uhppoted.Lib.Decode.Set_Time_Profile (Reply);
   begin
      Assert (Response = Expected, "incorrectly decoded set-time-profile-response response: got" & Response'Image);
   end Test_Decode_Set_Time_Profile;

   procedure Test_Decode_Clear_Time_Profiles (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Response : constant Clear_Time_Profiles_Response := Uhppoted.Lib.Decode.Clear_Time_Profiles (Reply);
   begin
   ...
   procedure Test_Decode_Refresh_Tasklist (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Response : constant Refresh_Task_List_Response := Uhppoted.Lib.Decode.Refresh_Task_List (Reply);
   begin
      Assert (Response = Expected, "incorrectly decoded refresh-task-list-response response: got" & Response'Image);
   end Test_Decode_Refresh_Tasklist;

   procedure Test_Decode_Clear_Tasklist (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Response : constant Clear_Task_List_Response := Uhppoted.Lib.Decode.Clear_Task_List (Reply);
   begin
   ...
   begin
      Assert (Response = Expected, "incorrectly decoded Set_PC_Control_Response response: got" & Response'Image);
   end Test_Decode_Set_PC_Control;

   procedure Test_Decode_Set_Interlock (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);

      Expected : constant Set_Interlock_Response := (
         Controller => 405419896,
         Ok         => True);

      Reply : constant Packet := [
         16#17#, 16#a2#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#01#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Response : constant Set_Interlock_Response := Uhppoted.Lib.Decode.Set_Interlock (Reply);
   begin
   ...
   procedure Test_Decode_Get_Antipassback (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);

      Expected : constant Get_Antipassback_Response := (
         Controller   => 405419896,
         Antipassback => 2);

      Reply : constant Packet := [
         16#17#, 16#86#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#02#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Response : constant Get_Antipassback_Response := Uhppoted.Lib.Decode.Get_Antipassback (Reply);
   begin
      Assert (Response = Expected, "incorrectly decoded Get_Antipassback_Response response: got" & Response'Image);
   end Test_Decode_Get_Antipassback;

   procedure Test_Decode_Set_Antipassback (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);

      Expected : constant Set_Antipassback_Response := (
         Controller => 405419896,
         Ok         => True);

      Reply : constant Packet := [
         16#17#, 16#84#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#01#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Response : constant Set_Antipassback_Response := Uhppoted.Lib.Decode.Set_Antipassback (Reply);
   begin
