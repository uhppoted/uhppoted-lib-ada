...
package body Uhppoted.Lib.Encode.Tests is
   ...
   procedure Test_Encode_Get_Cards (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Request : constant Packet := Uhppoted.Lib.Encode.Get_Cards (
         405419896);
   begin
   ...
   procedure Test_Encode_Delete_All_Cards (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      ...
      Request : constant Packet := Uhppoted.Lib.Encode.Delete_Cards (
         405419896);
   begin
   ...
   procedure Test_Encode_Set_Event_Index_Request (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);

      Expected : constant Packet := [
         16#17#, 16#b2#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#0b#, 16#35#, 16#00#, 16#00#, 16#55#, 16#aa#, 16#aa#, 16#55#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Request : constant Packet := Uhppoted.Lib.Encode.Set_Event_Index (
         405419896,
         13579);
   begin
      Assert (Request = Expected, "incorrectly encoded set-event-index request: got" & Request'Image);
   end Test_Encode_Set_Event_Index_Request;

   procedure Test_Encode_Record_Special_Events_Request (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   procedure Test_Encode_Get_Time_Profile (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);

      Expected : constant Packet := [
         16#17#, 16#98#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#25#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Request : constant Packet := Uhppoted.Lib.Encode.Get_Time_Profile (
         405419896,
         37);
   begin
   ...
   procedure Test_Encode_Set_Pc_Control_Request (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Expected : constant Packet := [
         16#17#, 16#a0#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#55#, 16#aa#, 16#aa#, 16#55#, 16#01#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];
   ...
   procedure Test_Encode_Restore_Default_Parameters (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Expected : constant Packet := [
         16#17#, 16#c8#, 16#00#, 16#00#, 16#78#, 16#37#, 16#2a#, 16#18#,  16#55#, 16#aa#, 16#aa#, 16#55#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
         16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#
      ];

      Request : constant Packet := Uhppoted.Lib.Encode.Restore_Default_Parameters (
         405419896);
   begin
      Assert (Request = Expected, "incorrectly encoded restore-default-parameters request: got" & Request'Image);
   end Test_Encode_Restore_Default_Parameters;
